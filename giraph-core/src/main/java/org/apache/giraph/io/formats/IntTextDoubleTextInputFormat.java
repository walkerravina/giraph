 ...
 */
public class IntTextDoubleTextInputFormat extends
    TextVertexInputFormat<IntWritable, Text, DoubleWritable> {
  ...
  /**
   * Vertex reader associated with {@link IntTextNullTextInputFormat}.
   */
  public class IntIntNullIntVertexReader extends
    ...
    protected Iterable<Edge<IntWritable, DoubleWritable>> getEdges(
      ...
      for (int n = 1; n < tokens.length; n++) {
        edges.add(EdgeFactory.create(new IntWritable(Integer.parseInt(tokens[n])), new DoubleWritable(0)));
      }
      return edges;
    }
  }
